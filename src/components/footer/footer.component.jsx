...
const Footer = () => {
  ...
  return (
    <>
      <Outlet />
      <div className="bg-[#148F7C] h-[80vh]">
        <div className="px-44 grid grid-cols-4 gap-x-4 gap-y-32 pb-16 pt-12 text-white font-bold">
          <div>
          ...
          <div className="flex flex-col border-t-2 border-white pt-8 col-start-3 py-8">
            <a
          ...
          <div className="border-t-2 border-white pt-8 col-start-3">
