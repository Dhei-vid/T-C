  ...
  return (
    <div className="px-44 text-lg">
      ...
      <div className="pt-6 pr-32">
        ...
        <p className="pb-4">
          <strong>Digitalesque Limited</strong> (“us”, “we”, or “our”) operates
          as <strong>https://digitalesque.xyz/</strong> (hereinafter referred to
          as <strong>“Service”</strong>).
        </p>
        <p className="pb-4">
          Our Privacy Policy governs your visit together
          <strong>https://digitalesque.xyz/</strong> and explains how we
          collect, safeguard and disclose information that results from your use
          of our Service.
        </p>
        <p className="pb-4">
          We use your data to provide and improve Service. By using the Service,
        ...
        <p className="pb-4">
          ...
          our Service and together with the Privacy Policy constitute your
        ...
        <div className="pt-6 pr-32">
          ...
          <p className="pb-4">0.1. Email address</p>
          <p className="pb-4">0.2. First name and last name</p>
          <p className="pb-4">0.3. Phone number</p>
          <p className="pb-4">
            0.4. Address, Country, State, Province, ZIP/Postal code, City
          </p>
          <p className="pb-4">0.5. Cookies and Usage Data</p>
          <p className="pb-4">
        ...
        <div className="pr-32">
          ...
          <p className="pb-4">Examples of Cookies we use:</p>
          <p className="pb-4">
        ...
        <div>
          ...
          <p className="pb-4">
            ...
            employment agreements, NDA<span> </span>agreements, information on
        ...
        <div className="pt-6 pr-32">
          ...
          <p className="pb-4">0.1. to provide and maintain our Service;</p>
          <p className="pb-4">
          ...
          <p className="pb-4">0.4. to provide customer support;</p>
          <p className="pb-4">
            0.5. to gather analysis or valuable information so that we can
            improve our Service;
          </p>
          <p className="pb-4">0.6. to monitor the usage of our Service;</p>
          <p className="pb-4">
        ...
        <div className="pt-6 pr-32">
          ...
          <p className="pb-4">
            If you are located outside Abuja, Nigeria. and choose to provide
            information to us, please note that we transfer the data, including
            Personal Data, to Abuja, Nigeria. and process it there.
          </p>
          <p className="pb-4">
          ...
          <p className="pb-4">
            Digitalesque Limited will take all the steps reasonably necessary to
        ...
        <div className="pt-6 pr-32">
          ...
          <p className="pb-4">0.3.1. to our subsidiaries and affiliates;</p>
          <p className="pb-4">
          ...
          <p className="pb-4">0.3.6. with your consent in any other cases;</p>
          <p className="pb-4">
        ...
        <div className="pt-6 pr-32">
          ...
          <p className="pb-4">
            ...
            <a href="mailto:support@digitalesque.xyz">
              support@digitalesque.xyz
            </a>
            .
          </p>
          <p className="pb-4">
            0.1. the right to access, update or delete the information we have
            on you;
          </p>
          <p className="pb-4">
          ...
          <p className="pb-4">
            ...
            withdraw your consent at any time when we rely on your consent to
        ...
        <div className="pt-6 pr-32">
          ...
          <p className="pb-4">
            The law’s reach requires a person or company in the Federal Republic
            of Nigeria (and conceivable the world) that operates websites
            collecting personally identifiable information from consumers to
          ...
          <p className="pb-4">According to NDPR, we agree to the following:</p>
          <p className="pb-4">0.1. users can visit our site anonymously;</p>
          <p className="pb-4">
          ...
          <p className="pb-4">Our Policy on “Do Not Track” Signals:</p>
          <p className="pb-4">
        ...
        <div className="pt-6 pr-32">
          ...
          <p className="pb-4">
            If you are a Nigerian resident, you are entitled to learn what data
          ...
          <p className="pb-4">
            0.1. What personal information do we have about you. If you make
          ...
          <p className="pb-4">
            ...
            accomplished through the de-identification of the information. If
          ...
          <p className="pb-4">
            ...
            Nigerian law. You are the only owner of your Personal Data and can
          ...
          <p className="pb-4">
            To exercise your Nigerian data protection rights described above,
            please send your request(s) by email:
            <a className="font-bold" href="mailto:support@digitalesque.xyz">
              support@digitalesque.xyz
            </a>
            .
          </p>
